# -*- coding: utf-8 -*-
"""
Created on Sat Jan  8 09:45:28 2022
    ...
    def __init__(self, path, features="ResNET_PCA512.npy", split=["train"], version=1, 
       ...
       # game_counter = 0
        ...
        for game in tqdm(self.listGames):
            ...
            ############################################### 
        #    if game_counter == 0:
        #        print("Before reshape, feat_half1 shape = ", feat_half1.shape)
            ############################################### 
            ...
            ############################################### 
       #     if game_counter == 0:
       #         print("After reshape, feat_half1 shape = ", feat_half1.shape)
            ############################################### 
            ...
            ############################################### 
      #      if game_counter == 0:
      #          print("Torch clips, feat_half1 shape = ", feat_half1.shape)
            ###############################################             
            ...
            ############################################### 
      #      if game_counter == 0:
      #          print("Label_half1 shape = ", label_half1.shape)
...
class SoccerNetClipsTesting(Dataset):
    ...
    def __getitem__(self, index):
        ...
        ############################################### 
     #   if index == 0:
     #      print("In testing, Label_half1 shape = ", label_half1.shape)
     #      print("In testing, Feat_half1 shape = ",  feat_half1.shape)
        ...
        ############################################### 
     #   if index == 0:
     #      print("In testing, Feat Clips pytorch Feat_half1 shape = ",  feat_half1.shape)
